        ...
        if(selectedOptionValue!= null && selectedOptionValue != ''){
            ...
            action.setCallback(this, function (response) {
                ...
                if (state === "SUCCESS") {
                    ...
                    if(storeResponse.listQuestion != null){
                        var listQuestion = [];
                        storeResponse.listQuestion.forEach(function(item,idx) {
                            console.log('listQuestion forEach', listQuestion);
                            listQuestion.push({
                                label:item.Name,
                                value:item.Id,
                                point:'',
    ...
    sendResultPoint: function (component, event, helper) {
        ...
        var action = component.get("c.postResultQuestion");
            ...
            if (state === "SUCCESS") {
                ...
                component.find('notifLib').showToast({
                    "title": "Thất bại!",
                    "message": "Có lỗi xảy ra. Bạn đã chấm điểm không thành công.",
                    "variant": "error"
                });
            }   
        });
